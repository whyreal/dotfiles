...
hi IncSearch ctermfg=16 ctermbg=107 cterm=NONE guifg=black guibg=yellow gui=NONE
...
"term=standout ctermfg=0 ctermbg=11 guifg=#7fbdff guibg=#425c78
...
hi Folded ctermfg=247 ctermbg=NONE cterm=NONE guifg=#5f5f5f guibg=NONE gui=NONE
...
hi NonText ctermfg=NONE ctermbg=NONE cterm=NONE guifg=#252c31 guibg=#252c31 gui=NONE
...
hi Title ctermfg=231 ctermbg=NONE cterm=bold guifg=black guibg=white gui=bold
"hi Title ctermfg=231 ctermbg=NONE cterm=bold guifg=#f0f0f0 guibg=NONE gui=bold
hi Todo ctermfg=black ctermbg=yellow cterm=bold guifg=red guibg=yellow gui=bold,italic
