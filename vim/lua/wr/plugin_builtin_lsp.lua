...
M.setup = function()
	...
	config = function ()
		...
		wr.map('n', '<leader>rn',    '<cmd>lua vim.lsp.buf.rename()<CR>')

		wr.autocmd [[CursorHold  *.lua,*.go,*.python lua vim.lsp.buf.document_highlight()]]
		wr.autocmd [[CursorHoldI *.lua,*.go,*.python lua vim.lsp.buf.document_highlight()]]
		wr.autocmd [[CursorMoved *.lua,*.go,*.python lua vim.lsp.buf.clear_references()]]
